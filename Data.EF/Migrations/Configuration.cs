    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Data.EF.PhukienDTDbContext>
    {
        ...
        protected override void Seed(Data.EF.PhukienDTDbContext context)
        {
			...
			var sanphams = new List<Sanpham>
			{
				...
				new Sanpham{masp="2",tensp="Ốp hoạt hình",maloai=1,mancc=2,dongia=40000,soluong=100,mota="Đây là sp thứ 2",tenhinh="2.png",khuyenmai=0},
				...
				new Sanpham{masp="5",tensp="Ốp hình Icebear",maloai=1,mancc=9,dongia=60000,soluong=100,mota="Đây là sp thứ 1",tenhinh="5.png",khuyenmai=0},
				new Sanpham{masp="6",tensp="Ốp hình hàn quốc",maloai=1,mancc=9,dongia=60000,soluong=100,mota="Đây là sp thứ 1",tenhinh="6.png",khuyenmai=0},
				...
				new Sanpham{masp="8",tensp="Ốp hình Icebear",maloai=1,mancc=9,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="8.png",khuyenmai=0},
				new Sanpham{masp="9",tensp="Ốp hình Icebear",maloai=1,mancc=8,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="9.png",khuyenmai=0},
				new Sanpham{masp="10",tensp="Ốp trơn",maloai=1,mancc=7,dongia=70000,soluong=100,mota="Đây là sp thứ 1",tenhinh="10.png",khuyenmai=0},
				...
				new Sanpham{masp="12",tensp="Ốp trơn",maloai=1,mancc=5,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="12.png",khuyenmai=0},
				new Sanpham{masp="13",tensp="Ốp hình Icebear",maloai=4,mancc=1,dongia=80000,soluong=100,mota="Đây là sp thứ 1",tenhinh="13.png",khuyenmai=0},
				...
				new Sanpham{masp="15",tensp="Ốp trơn",maloai=1,mancc=3,dongia=84000,soluong=100,mota="Đây là sp thứ 1",tenhinh="15.png",khuyenmai=0},
				...
				new Sanpham{masp="18",tensp="Ốp họa tiết",maloai=1,mancc=10,dongia=40000,soluong=100,mota="Đây là sp thứ 1",tenhinh="18.png",khuyenmai=0},
				...
				new Sanpham{masp="21",tensp="Ốp trơn",maloai=1,mancc=10,dongia=19000,soluong=100,mota="Đây là sp thứ 1",tenhinh="21.png",khuyenmai=0},
				new Sanpham{masp="22",tensp="Ốp trơn",maloai=1,mancc=10,dongia=35000,soluong=100,mota="Đây là sp thứ 1",tenhinh="22.png",khuyenmai=0},
				new Sanpham{masp="23",tensp="Ốp trơn",maloai=1,mancc=10,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="23.png",khuyenmai=0},
				...
				new Sanpham{masp="25",tensp="Ốp trơn",maloai=1,mancc=10,dongia=54000,soluong=100,mota="Đây là sp thứ 1",tenhinh="25.png",khuyenmai=0},
				...
				new Sanpham{masp="27",tensp="Ốp trơn",maloai=1,mancc=9,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="27.png",khuyenmai=0},
				...
				new Sanpham{masp="30",tensp="Ốp trơn",maloai=1,mancc=8,dongia=55000,soluong=100,mota="Đây là sp thứ 1",tenhinh="30.png",khuyenmai=0},
				new Sanpham{masp="31",tensp="Ốp trơn",maloai=1,mancc=10,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="31.png",khuyenmai=0},
				...
				new Sanpham{masp="33",tensp="Ốp trơn",maloai=1,mancc=7,dongia=10000,soluong=100,mota="Đây là sp thứ 1",tenhinh="33.png",khuyenmai=0},
				...
				new Sanpham{masp="35",tensp="Ốp trơn",maloai=1,mancc=6,dongia=22000,soluong=100,mota="Đây là sp thứ 1",tenhinh="35.png",khuyenmai=0},
				...
				new Sanpham{masp="38",tensp="Ốp trơn",maloai=1,mancc=5,dongia=65000,soluong=100,mota="Đây là sp thứ 1",tenhinh="38.png",khuyenmai=0},
				...
				new Sanpham{masp="43",tensp="Ốp kính siêu nhân",maloai=1,mancc=4,dongia=110000,soluong=100,mota="Đây là sp thứ 1",tenhinh="43.png",khuyenmai=0},
				new Sanpham{masp="44",tensp="Ốp hình hàn quốc",maloai=1,mancc=4,dongia=110000,soluong=100,mota="Đây là sp thứ 1",tenhinh="44.png",khuyenmai=0},
				new Sanpham{masp="45",tensp="Ốp hình hàn quốc",maloai=1,mancc=5,dongia=65000,soluong=100,mota="Đây là sp thứ 1",tenhinh="45.png",khuyenmai=0},
				new Sanpham{masp="46",tensp="Ốp hình hàn quốc",maloai=1,mancc=5,dongia=55000,soluong=100,mota="Đây là sp thứ 1",tenhinh="46.png",khuyenmai=0},
				...
				new Sanpham{masp="48",tensp="Ốp kính siêu nhân",maloai=1,mancc=3,dongia=90000,soluong=100,mota="Đây là sp thứ 1",tenhinh="48.png",khuyenmai=0},
				...
				new Sanpham{masp="50",tensp="Ốp nhám vô diện",maloai=1,mancc=10,dongia=70000,soluong=100,mota="Đây là sp thứ 1",tenhinh="50.png",khuyenmai=0},
				new Sanpham{masp="r1",tensp="Ring Gấu Trúc ",maloai=3,mancc=9,dongia=90000,soluong=100,mota="Đây là sp thứ 1",tenhinh="r1.png",khuyenmai=0},
				...
				new Sanpham{masp="r3",tensp="Ring Gấu Đen Dễ Thương ",maloai=3,mancc=9,dongia=95000,soluong=100,mota="Đây là sp thứ 3",tenhinh="r3.png",khuyenmai=0},
				...
				new Sanpham{masp="r5",tensp="Ring Que Kem",maloai=3,mancc=8,dongia=60000,soluong=100,mota="Đây là sp thứ 1",tenhinh="r5.png",khuyenmai=0},
				...
				new Sanpham{masp="r7",tensp="Ring Ốp La ",maloai=3,mancc=8,dongia=90000,soluong=100,mota="Đây là sp thứ 7",tenhinh="r7.png",khuyenmai=0},
				...
				new Sanpham{masp="r9",tensp="Ring Gấu Trắng  ",maloai=3,mancc=6,dongia=94000,soluong=100,mota="Đây là sp thứ 1",tenhinh="r9.png",khuyenmai=0},
				new Sanpham{masp="r10",tensp="Ring Gấu Nâu ",maloai=3,mancc=5,dongia=80000,soluong=100,mota="Đây là sp thứ 10",tenhinh="r10.png",khuyenmai=0},
				...
				new Sanpham{masp="r12",tensp="Ring Mèo Vàng ",maloai=3,mancc=4,dongia=90000,soluong=100,mota="Đây là sp thứ 12",tenhinh="r12.png",khuyenmai=0},
				...
				new Sanpham{masp="r14",tensp="Ring Mèo Meo ",maloai=3,mancc=4,dongia=70000,soluong=100,mota="Đây là sp thứ 14",tenhinh="r14.png",khuyenmai=0},
				...
				new Sanpham{masp="r18",tensp="Ring Cầu Vồng ",maloai=3,mancc=10,dongia=140000,soluong=100,mota="Đây là sp thứ 18",tenhinh="r18.png",khuyenmai=0},
				...
				new Sanpham{masp="a1",tensp="Bao AirPod Jordan 23 ",maloai=2,mancc=9,dongia=120000,soluong=100,mota="Đây là sp thứ 1",tenhinh="a1.png",khuyenmai=0},
				...
				new Sanpham{masp="a17",tensp="Bao AirPod Pop Corn ",maloai=2,mancc=9,dongia=170000,soluong=100,mota="Đây là sp thứ 1",tenhinh="a17.png",khuyenmai=0},
				...
				new Sanpham{masp="a19",tensp="Bao AirPod Ếch Ộp ",maloai=2,mancc=7,dongia=130000,soluong=100,mota="Đây là sp thứ 1",tenhinh="a19.png",khuyenmai=0},
				...
				new Sanpham{masp="p1",tensp="Pop Mèo Xám ",maloai=3,mancc=8,dongia=140000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p1.png",khuyenmai=0},
				...
				new Sanpham{masp="p3",tensp="Pop Biểu Tượng  ",maloai=3,mancc=5,dongia=110000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p3.png",khuyenmai=0},
				...
				new Sanpham{masp="p5",tensp="Pop Galaxy ",maloai=3,mancc=6,dongia=60000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p5.png",khuyenmai=0},
				...
				new Sanpham{masp="p7",tensp="Pop Shin Cậu Bé Bút Chì ",maloai=3,mancc=4,dongia=135000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p7.png",khuyenmai=0},
				...
				new Sanpham{masp="p16",tensp="Pop Chị Ong Vàng ",maloai=3,mancc=6,dongia=170000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p16.png",khuyenmai=0},
				new Sanpham{masp="p17",tensp="Pop Iron Man ",maloai=3,mancc=7,dongia=120000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p17.png",khuyenmai=0},
				new Sanpham{masp="p18",tensp="Pop Batman ",maloai=3,mancc=7,dongia=140000,soluong=100,mota="Đây là sp thứ 1",tenhinh="p18.png",khuyenmai=0},
				...
				new Sanpham{masp="k1",tensp="Dây Đeo Marvel ",maloai=4,mancc=8,dongia=150000,soluong=100,mota="Đây là sp thứ 1",tenhinh="k1.png",khuyenmai=0},
				new Sanpham{masp="k2",tensp="Dây Đeo Con Mắt ",maloai=4,mancc=8,dongia=130000,soluong=100,mota="Đây là sp thứ 1",tenhinh="k2.png",khuyenmai=0},
